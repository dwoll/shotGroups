...
\item \texttt{getMinCircle()}: Calculates center and radius of the minimum enclosing circle. This is the smallest circle that contains all points (bullet hole centers). Uses the Skyum algorithm \cite{Skyum1991}. Note that faster and likely more numerically stable algorithms exist, also for generalizing the problem to higher dimensions \cite{Fischer2003,CGAL2021,Gartner2022}.
...
\item Articles, technical reports or Master's theses comparing the characteristics of CEP estimators in different scenarios \cite{Blischke1966,Elder1986,Kamat1962,McMillan2008,Moranda1959,Moranda1960,Nelson1988,Puhek1992,Tongue1993,Taub1983a,Wang2013a,Wang2013b,Wang2014,Williams1997,Carlson2021}.
